...
class RobotContainer:
    ...
    def __init__(self):
        ...
        self.auton_selector.setDefaultOption("PATHPLANNER: Center 4 Piece", PathPlannerAutoRunner("IMPORTANT Center Subwoofer 4 Piece", self.s_Swerve).getCommand())
        self.auton_selector.addOption("PATHPLANNER: Left Subwoofer 3 Piece (A3 M5)", PathPlannerAutoRunner("LeftSubwoofer3PieceA3M5", self.s_Swerve).getCommand())
        self.auton_selector.addOption("PATHPLANNER: Right Subwoofer 3 Piece", PathPlannerAutoRunner("RightSubwoofer3MidlinePiece", self.s_Swerve).getCommand())
        ...
        self.auton_selector.addOption("center4Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, center4PieceJSON).getCommand())
        ...
        self.auton_selector.addOption("center45Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, center45PieceJSON).getCommand())
        Center35PieceJSON =  [{"x":1.3600420533333335,"y":5.602741510067114,"theta":0,"type":"Shot","id":0,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.940631466666667,"y":5.602741510067114,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.141873373333334,"y":4.151539610738254,"theta":0,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":3.9882314266666667,"y":5.602741510067114,"theta":0,"type":"Shot","id":3,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.178631266666667,"y":5.84154688590604,"theta":0,"type":"Regular","id":4,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Center 3.5 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Center35PieceJSON).getCommand())
        amp4PieceJSON =  [{"x":0.6248841866666667,"y":6.778398744966443,"theta":60,"type":"Shot","id":0,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.775220946666667,"y":6.962095187919463,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.215389159999999,"y":7.5499238053691275,"theta":0,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.775220946666667,"y":6.925355899328858,"theta":15,"type":"Shot","id":3,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.8671156800000004,"y":5.547632577181208,"theta":-90,"type":"Shot","id":4,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("amp4Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, amp4PieceJSON).getCommand())
        Source3PieceJSON =  [{"x":0.7167789200000001,"y":4.371975342281879,"theta":-60,"type":"Shot","id":0,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.5914314800000002,"y":4.169909255033557,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.068357586666666,"y":0.8633732818791948,"theta":0,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.3341262266666667,"y":3.47186277181208,"theta":-30,"type":"Shot","id":3,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Source 3 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Source3PieceJSON).getCommand())
        Source35PieceJSON =  [{"x":0.7167789200000001,"y":4.371975342281879,"theta":-60,"type":"Shot","id":0,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.5914314800000002,"y":4.169909255033557,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.123494426666667,"y":2.4431626912751683,"theta":0,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.3341262266666667,"y":3.47186277181208,"theta":-30,"type":"Shot","id":3,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":8.031599693333334,"y":0.8082643489932889,"theta":0,"type":"Regular","id":4,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Source 3.5 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Source35PieceJSON).getCommand())
        WorkshopCalibTest1JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Regular","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":0,"type":"Regular","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 1", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest1JSON).getCommand())
        WorkshopCalibTest2JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Regular","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":-45,"type":"Regular","id":1,"status":"Edit","delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 2", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest2JSON).getCommand())
        WorkshopCalibTest3JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Regular","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":0,"type":"Regular","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":7.017204120805369,"theta":0,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 3", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest3JSON).getCommand())
        WorkshopCalibTest4JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Shot","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.8487367333333333,"y":5.584371865771812,"theta":0,"type":"Regular","id":1,"status":"Edit","delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 4", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest4JSON).getCommand())
        WorkshopCalibTest5JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Shot","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 5", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest5JSON).getCommand())
        WorkshopCalibTest6JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Shot","id":0,"status":null,"delay":"0","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":0,"type":"Shot","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.7935998933333335,"y":6.980464832214764,"theta":70,"type":"Shot","id":2,"status":"Edit","delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 6", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest6JSON).getCommand())
        WorkshopCalibTest7JSON =  [{"x":1.378421,"y":5.584371865771812,"theta":0,"type":"Regular","id":0,"status":null,"delay":"5","continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.885494626666667,"y":5.584371865771812,"theta":0,"type":"Regular","id":1,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]},{"x":2.7935998933333335,"y":6.980464832214764,"theta":70,"type":"Regular","id":2,"status":null,"delay":0,"continueAsPlanned":["continue","continue","continue","continue"]}]
        self.auton_selector.addOption("Workshop Calib Test 7", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest7JSON).getCommand())

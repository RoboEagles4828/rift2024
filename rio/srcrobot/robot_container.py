...
class RobotContainer:
    ...
    def __init__(self):
        ...
        self.auton_selector.setDefaultOption("Center 3.5 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Center35PieceJSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("amp4Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, amp4PieceJSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Source 3 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Source3PieceJSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Source 3.5 Piece", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, Source35PieceJSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Workshop Calib Test 1", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest1JSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Workshop Calib Test 2", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest2JSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Workshop Calib Test 3", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest3JSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Workshop Calib Test 4", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest4JSON).getCommand())
        ...
        self.auton_selector.setDefaultOption("Workshop Calib Test 5", autoRunner(self.s_Swerve, self.s_Intake, self.s_Indexer, self.s_Shooter, self.s_Arm, self.s_Vision, WorkshopCalibTest5JSON).getCommand())

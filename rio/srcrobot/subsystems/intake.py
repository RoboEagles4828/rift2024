...
class Intake(Subsystem):
    ...
    def intakeOnce(self):
        return self.runOnce(lambda: self.intakeMotor.set(TalonSRXControlMode.PercentOutput, 1.0))
    
    def outtake(self):
        return self.run(lambda: self.intakeMotor.set(TalonSRXControlMode.PercentOutput, -1.0))

    def stopIntake(self):
        return self.runOnce(lambda: self.intakeMotor.set(TalonSRXControlMode.Current, 0.0))
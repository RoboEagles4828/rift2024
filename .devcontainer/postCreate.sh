...
echo "if [ ! -d /workspaces/rift2024/install ]; then" >> ~/.zshrc
echo "echo -e 'No install folder found remember to build with ctrl + shift + b\n';" >> ~/.zshrc
echo "else source /workspaces/rift2024/install/setup.zsh; fi" >> ~/.zshrc
...
isaac rm &
isaac-ros rm &
rm -rf /workspaces/rift2024/install /workspaces/rift2024/build /workspaces/rift2024/log